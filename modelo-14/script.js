const channelData = {
  cinema: { title: 'La última función', meta: 'CANAL 04 · CINE · AHORA', hero: 'Una noche fuera de eje' },
  sport: { title: 'La cancha abierta', meta: 'CANAL 07 · DEPORTE · EN VIVO', hero: 'El partido que no espera' },
  night: { title: 'Frecuencia nocturna', meta: 'CANAL 09 · MÚSICA · EN VIVO', hero: 'Sonido para mirar' }
};
  ...
  document.querySelectorAll('a[href*="wa.me"]').forEach((link) => {
    link.addEventListener('click', () => {
      if (typeof window.fbq === 'function') {
        window.fbq('track', 'Lead', { content_name: 'OptiXtream Orbital Pulse 14' });
      }
    });
  });
}
